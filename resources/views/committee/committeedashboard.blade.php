      ...
      <main class="app-main">
        ...
        <div class="app-content">
          <div class="container mt-5">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <form action="{{ route('events.destroy', $event->id) }}" method="POST" style="display:inline-block;">
                                    @csrf
                                    @method('DELETE')
                                    <button onclick="return confirm('Yakin ingin menghapus event ini?')" class="btn btn-sm btn-danger mb-1">Hapus</button>
                                </form>
                            </td>
                        </tr>
                    @empty
            ...
            @if ($events->count() > 0)
                <div class="mt-4">
                    <a href="{{ route('attendances.index') }}" class="btn btn-info">Lihat Presensi</a>
                    <a href="{{ route('attendances.scanned') }}" class="btn btn-success">Sudah Presensi</a>
                </div>
            @endif
          </div>   
        </div>
